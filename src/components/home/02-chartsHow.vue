    ...
    section.margin-3
      .columns.is-vcentered
        .column.is-offset-2.one-third.card.t-corner
          .card-content
            img(src="../../assets/images/automacao-anuncios-icon.png", alt="Automação de anúncios")
        ...
        .column.is-half.is-paddingless
          figure.image.is-16by9
            img(src="../../assets/images/automacao-anuncios.jpg", alt="Automação de anúncios ícone")
