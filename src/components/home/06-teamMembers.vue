...
section.section.container.content
  ...
  p.subtitle.has-text-centered
    | Formada por profissional conceituados em suas áreas que se conheceram buscando inovar em outros países, o Casahub está sempre em busca de soluções para ajudar a desenvolver soluções para o ramo habitacional.
  .columns
    .column
      .message.is-link
        ...
        .message-body.has-background-white.has-text-centered
          figure.image.is-200x200.has-image-centered
            source(type="image/webp" src="../../assets/images/rafaela-tulio.webp", alt="Rafaela Tulio - CEO")
    ...
    .column
      .message.is-danger
        ...
        .message-body.has-background-white.has-text-centered
          figure.image.is-200x200.has-image-centered
            source(type="image/webp" src="../../assets/images/fabio-paitra.webp", alt="Fabio Paitra - CMO")
    ...
    .column
      .message.is-info
        ...
        .message-body.has-background-white.has-text-centered
          figure.image.is-200x200.has-image-centered
            source(type="image/webp" src="../../assets/images/elliot-braham.webp", alt="Elliot Braham - CTO")
