  ...
  p.subtitle.has-text-centered O Casahub é a plataforma que sua equipe está solicitando - é a plataforma que os corretores precisam, construído com a tecnologia que os desenvolvedores preferem e integra com todas as suas outras ferramentas.
    .columns
      .column
        .columns.is-mobile
          .column.is-one-third-mobile
            img(src="../../assets/images/anuncie-nos-principais-portais.webp", alt="Anuncie nos principais portais")
          .column
        ...
        .columns.is-mobile
          .column.is-one-third-mobile
            img(src="../../assets/images/dicas-desempenho.webp", alt="Dicas de desempenho")
          .column
            h3.title.is-4.has-text-weight-light
      ...
      .column
        .columns.is-mobile
          .column.is-one-third-mobile
            img(src="../../assets/images/acompanhe-performance.webp", alt="Acompanhe a performance")
          .column
            h3.title.is-4.has-text-weight-light
        ...
        .columns.is-mobile
          .column.is-one-third-mobile
            img(src="../../assets/images/direcione-divulgacao.webp", alt="Direcione a divulgação")
          .column
            h3.title.is-4.has-text-weight-light
